...
// ---------- ROOT APP (LOGIN GATE + SHELL) ----------

function App() {
  const [isLoggedIn, setIsLoggedIn] = useState(false);

  // On first load, check if a token exists
  useEffect(() => {
  ...
  if (!isLoggedIn) {
    // Full-page login experience (LoginForm already renders .nf-login-page etc.)
    return <LoginForm onLoggedIn={() => setIsLoggedIn(true)} />;
  }

  // Once logged in → render the full NexusFlow One control unit shell
  return <NexusShell onLogout={handleLogout} />;
}

// ---------- MAIN AUTHENTICATED SHELL ----------

function NexusShell({ onLogout }) {
    ...
    <header className="nf-topbar">
      ...
      <div className="nf-topbar-right">
        ...
        <div className="nf-topbar-actions">
          ...
          <div className="nf-user-badge">
            <div className="nf-user-avatar">MR</div>
            <div className="nf-user-meta">
              <div className="nf-user-name">Maria Robles</div>
              <div className="nf-user-role">Owner / Admin</div>
            </div>
            <button
              className="nf-btn nf-btn-outline-sm nf-user-logout"
              onClick={onLogout}
            >
              Logout
            </button>
...
function Sidebar({ activePage, onChangePage }) {
  const groups = [
    {
      label: "Home & Strategy",
      pages: [PAGES.OVERVIEW, PAGES.ANALYTICS, PAGES.AI_BRAIN],
    },
    {
    ...
    {
      label: "Platform, Data & Governance",
      pages: [
        PAGES.USERS,
        PAGES.INTEGRATIONS,
        PAGES.AI_MODELS,
  ...
  return (
    <div className="nf-page">
      <header className="nf-page-header">
        <h1 className="nf-page-title">Executive Command Dashboard</h1>
        <p className="nf-page-subtitle">
          ...
          control every workflow, node, and decision path as if this were a
      ...
      <section className="nf-grid nf-grid-3 nf-section-space">
        ...
        <div className="nf-card">
          <h2 className="nf-card-title">Quick Launch Actions</h2>
          <ul className="nf-list">
            <li>Open Automation Studio to design or modify a workflow.</li>
            <li>Review Activity & Audit for latest deployments and changes.</li>
            <li>Connect CRM, billing, and support tools in Integration Hub.</li>
            <li>Invite operators and admins from Users & Access.</li>
          </ul>
          <div className="nf-section-space nf-control-inline">
            <button className="nf-btn nf-btn-accent">
